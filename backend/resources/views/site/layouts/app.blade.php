...
<html lang="pt-br">
    <head>
        ...
        <!--Resets-->
        <link href="{{url('assets/site/css/dropdown.css')}}" rel="stylesheet">
        ...
        <!--Favicon-->
        <link rel="icon" href="{{url('assets/site/images/logo.png')}}" type="image/png">
    </head>
    <body>
        ...
        <div class="footer-copy">
            <div class="container">
                <p>© TODOS OS DIREITOS RESERVADOS - ALETUR</p>
            </div>
        </div><!--Footer Copy-->
